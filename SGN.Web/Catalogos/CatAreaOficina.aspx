<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CatAreaOficina.aspx.cs" Inherits="SGN.Web.Catalogos.CatAreaOficina" %>
...
<body>
    ...
    <form id="form1" runat="server" class="Principal">
        ...
        <section class="CLPageContent" id="maindiv">
            ...
            <dx:ASPxGridView runat="server" ID="gvArea" ClientInstanceName="gvArea" AutoGenerateColumns="False" Width="100%" KeyFieldName="IdArea"
                OnDataBinding="gvArea_DataBinding"
                OnRowInserting="gvArea_RowInserting"
                OnRowUpdating="gvArea_RowUpdating"
                OnRowValidating="gvArea_RowValidating"
                OnToolbarItemClick="gvArea_ToolbarItemClick"
                OnCustomCallback="gvArea_CustomCallback">
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Visible="true" VisibleIndex="2" Caption="Area Oficina" FieldName="TextoAreaOficina" Width="300px">
