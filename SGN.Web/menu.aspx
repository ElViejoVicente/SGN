...
<body>
    ...
    <div id="menudiv" style="width:100%; height:96.5%" class="collapse show">
        ...
        <div id="menuPanel" >
            <form id="frmMEnu" runat="server" style="height:1300px;width:100%;overflow-y:auto">
                    ...
                    <tr style="height: 60%;border:0px solid green">
                        <td style="height: 100%">
                            <div id="Div1" style="width: 100%; height: 100%;">
                                <div id="ContMenu" class="contmenu" style="">
                                    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                        <ContentTemplate>
                                            <dx:ASPxTreeView ID="rtvMenu" runat="server" Theme="MetropolisBlue" OnNodeClick="rtvMenu_NodeClick" ScrollBars="yes" CssClass="treMenu">
