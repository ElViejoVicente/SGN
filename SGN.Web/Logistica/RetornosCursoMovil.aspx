<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RetornosCursoMovil.aspx.cs" Inherits="GPB.Web.RetornosCursoMovil" %>
    ...
    <form id="frmPageMovil" runat="server" class="Principal">
        ...
        <header class="CLPageHeader">
          <dx:ASPxImage runat="server" ID="imagenLogo" CssClass="imagenLogo">  </dx:ASPxImage>
            <dx:ASPxLabel ID="lblNombrePagina" CssClass="titleHeader" runat="server" Text="Plantilla Móvil" Font-Bold="true"></dx:ASPxLabel>
